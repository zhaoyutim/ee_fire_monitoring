...
def get_dateset_gedi(batch_size, nchannels):
    ...
    x_train, x_val, y_train, x_val = train_test_split(train_array[:,:,:,:nchannels], y_dataset, test_size=0.2, random_state=0)
...
if __name__=='__main__':
    ...
    model.save('/geoinfo_vol1/zhao2/proj4_model/proj4_'+model_name+'_pretrained_'+backbone+'_dataset_'+'_nchannels_'+str(nchannels))
